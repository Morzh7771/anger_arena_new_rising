...
if IMBA_PICK_SCREEN == true then
	require('lib/hero_selection/hero_selection')
	require('lib/hero_selection/event')
	require('lib/hero_selection/fun')()
	require('lib/hero_selection/functional')
	require('lib/hero_selection/cmpickorder')
else
