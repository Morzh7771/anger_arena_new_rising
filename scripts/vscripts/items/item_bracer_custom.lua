...
modifier_item_bracer_custom = class({
    ...
    GetModifierBonusStats_Strength = function (self) if self:GetAbility() then return self:GetAbility():GetSpecialValueFor("str") end end,
    GetModifierBonusStats_Intellect = function (self) if self:GetAbility() then return self:GetAbility():GetSpecialValueFor("int") end end,
    GetModifierBonusStats_Agility = function (self) if self:GetAbility() then return self:GetAbility():GetSpecialValueFor("agi") end end,
    GetModifierPreAttack_BonusDamage = function (self) if self:GetAbility() then return self:GetAbility():GetSpecialValueFor("damage") end end,
    GetModifierConstantHealthRegen = function (self) if self:GetAbility() then return self:GetAbility():GetSpecialValueFor("regen") end end,
})
